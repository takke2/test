...
function init() {
    ...
    for(i = 0; i < CHARA_SHOT_MAX_COUNT; i++){
        ...
        if(i == CHARA_SHOT_MAX_COUNT-1){
            ...
            charaShotMesh[i] = new THREE.Mesh(new THREE.SphereGeometry(specialSize), new THREE.MeshPhongMaterial({color : 0xaa0000,specular: 0x999999,shininess: 80,opacity: 0.5, transparent: true,emissive: 0x222200,emissiveIntensity: 3}));
        }else{
