...
function init() {
    ...
    effects["Laser01"] = effekseer.loadEffect("https://cdn.rawgit.com/effekseer/EffekseerForWebGL/7a1b035c/Release/Sample/Resource/aqua.efk");
    ...
    conteText2D.fillText ( "9/15-5" , 0 , 10 , 100 );
