...
CharacterShot.prototype.move = function(){
	...
	if(this.position.x > this.size+this.position.x || this.position.y+this.position.y > this.size || this.position.z+this.position.z > this.size ||
	   this.position.x < -this.size-this.position.x || this.position.y < -this.size-this.position.y || this.position.z < -this.size-this.position.z){
		this.alive = false;
	}
};
